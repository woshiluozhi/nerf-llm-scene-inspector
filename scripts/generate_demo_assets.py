...
def _write_portfolio_result_card(
    ...
    *,
    ...
    lines = [
        ...
        "- Implemented deterministic query planning, semantic relevancy artifacts, experiment-matrix summaries, spatial/evaluation utilities, and CPU-only dry-run demos.",
        "",
