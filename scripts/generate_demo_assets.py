...
def _write_portfolio_result_card(
    ...
    *,
    ...
    lines = [
        ...
        "- Implemented deterministic query planning, semantic relevancy artifacts, experiment-matrix summaries, paper-style research reports, submission checklists, spatial/evaluation utilities, and CPU-only dry-run demos.",
        "",
