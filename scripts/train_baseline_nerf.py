#!/usr/bin/env python
"""Train a baseline Nerfstudio NeRF."""
...
from nerf_llm_scene_inspector.training import train_baseline_nerf  # noqa: E402


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--data", required=True, help="Processed Nerfstudio data directory.")
    parser.add_argument("--method", default="nerfacto", help="Nerfstudio method, default: nerfacto.")
...
def main() -> int:
    ...
    try:
        ...
        print(f"train_baseline_nerf failed: {exc}", file=sys.stderr)
        return 1
