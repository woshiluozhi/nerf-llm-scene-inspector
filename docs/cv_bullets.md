...
- Built CPU-safe reproducibility infrastructure including dry-run training/query simulation, CI checks, real-run preflight reports, processed-scene quality reports, evidence scorecards, run-scoped portfolio packs, and professor-facing documentation.
