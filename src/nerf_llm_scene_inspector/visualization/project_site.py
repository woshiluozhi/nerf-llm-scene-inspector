    ...
    def to_html(self) -> str:
        ...
        return "\n".join(
            [
                ...
                _capability("Evidence packaging", "Reports, audits, scorecards, static pages, and share-safe portfolio packs."),
                "      </div>",
                "    </section>",
                ...
                "        <ol class=\"workflow\">",
                "          <li><strong>Capture</strong><span>Slow phone video or overlapping images of a static scene.</span></li>",
                ...
                "          <li><strong>Query</strong><span>Generate relevancy overlays, reports, metrics, and portfolio artifacts.</span></li>",
                "        </ol>",
                "      </div>",
                _code_panel(),
                "    </section>",
